...
`cargo truce validate` runs [clap-validator](https://github.com/free-audio/clap-validator) against installed `.clap` bundles. The upstream repo is actively maintained (v0.4.1+).
...
- **Validator:** [free-audio/clap-validator](https://github.com/free-audio/clap-validator)
